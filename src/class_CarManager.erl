...
construct( State, ?wooper_construct_parameters ) ->
	...
	setAttributes( ActorState, [ { car_list, DictCars }, { graph_manager, GraphManagerPid } ] ).
...
create_person_car( Count , State , CarName , ListTripsFinal , Type , Park , Mode, Uuid ) ->
	...
	NewState = class_Actor:create_actor( class_Car,
		[ CarFinalName , ListTripsFinal , StartTime , Type , Park , Mode, GraphManagerPid, Uuid ] , State ),
