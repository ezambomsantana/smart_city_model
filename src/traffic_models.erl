...
get_speed_car({_, Id, Length, _RawCapacity, Freespeed, _NumberCars, _Lanes, {_DRName, _DigitalRailsLanes, _Cycle, _Bandwidth, _Signalized, _Offset}}, true) ->
...
get_speed_car({_, Id, Length, RawCapacity, Freespeed, NumberCars, Lanes, {_DRName, DigitalRailsLanes, _Cycle, _Bandwidth, _Signalized, _Offset}}, false) ->
